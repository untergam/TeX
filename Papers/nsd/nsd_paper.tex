...
as shown in figure \ref{fig:oscillatory_integral_complex_sp}. This will then give an exact
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\linewidth]{./fig/nsd_path_csp_figure.pdf}
