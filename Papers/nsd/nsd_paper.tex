...
suitable quadrature rule, in this case Gauss-Hermite rules, directly to the
integrand $I = \braket{\phi|\phi^\prime}$. Since our interests stem from quantum
mechanics, we anticipate the integrand being composed of wavepackets $\phi$,
forming overlap integrals.
