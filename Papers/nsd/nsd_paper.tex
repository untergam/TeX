...
for multivariate integrands. Semi-finite intervals are treated in \cite{H_nsd_sii}.
...
of overlap integrals. Semiclassical wavepackets in $D$ dimensions are constructed
from a groundstate:
\begin{align*}
...
All these parameters are usually collected in the set
$\Pi \assign \{\vec{q}, \vec{p}, \mat{Q}, \mat{P}\}$.
...
exists an exact formula which is very expensive to evaluate numerically.} like
