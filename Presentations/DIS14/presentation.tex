...
\begin{frame}{Motivation}
  \begin{itemize}
    ...
    \end{equation*}
    \item Common techniques give \emph{wrong} results
  \end{itemize}
  \begin{figure}
    \centering
...
\begin{frame}{Steepest Descent for Wavepackets}{Transformation of the Oscillator}
  \begin{itemize}
    ...
    \begin{itemize}
      \item Optimal, \emph{not} possible via unitary matrices ($\mat{A}$ not Hermitian)
    \end{itemize}
...
\begin{frame}{Final Solution for computing overlap Integrals}
  \begin{itemize}
    ...
    \begin{itemize}
      \item Steepest Descent: \emph{remove oscillations}
      \item Sparse Grid: \emph{lessen curse of dimensionality}
      \item Genz-Keister rules: \emph{make nodes nested}
    \end{itemize}
  \end{itemize}
  \begin{figure}
    \centering
