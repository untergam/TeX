...
Interestingly enough, if only a \emph{LT} splitting is used in the \proc{IntSplit} method, then the simplistic \emph{Hagedorn} propagator outperforms all the others. However, changing the splitting scheme to \emph{Y4} again gives the expected behaviour.
%
\begin{figure}[ht]
	\centering
